ETXCOIN-qt: Qt4 GUI for ETXCOIN
===============================
...
Alternatively, install Qt Creator and open the `ETXCOIN-qt.pro` file.

An executable named `ETXCOIN-qt` will be built.
...
A warning for people using the *static binary* version of ETXCOIN on a Linux/UNIX-ish system (tl;dr: **Berkely DB databases are not forward compatible**).

The static binary version of ETXCOIN is linked against libdb5.3.
...
installed causes ETXCOIN-qt to crash intermittently.  The issue has been reported as `launchpad bug 857790`_, but
isn't yet fixed.
