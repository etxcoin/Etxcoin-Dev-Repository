...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("ETX");
    case mBTC: return QString("mETX");
    case uBTC: return QString::fromUtf8("μETX");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("ETXCOINs"));
    case mBTC: return QString(QObject::tr("Milli-ETXCOINs (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-ETXCOINs (1 / 1,000,000)"));
    default: return QString("???");
    }
}
